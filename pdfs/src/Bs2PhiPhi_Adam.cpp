/** @class Bs2PhiPhi_Adam Bs2PhiPhi_Adam.cpp
 *
...
PDF_CREATOR( Bs2PhiPhi_Adam )
/*****************************************************************************/
// Constructor
Bs2PhiPhi_Adam::Bs2PhiPhi_Adam(PDFConfigurator* config) :
  // Dependent variables
    phi     (0.0)
  , ctheta_1(0.0)
  , ctheta_2(0.0)
...
/*****************************************************************************/
// Copy constructor
Bs2PhiPhi_Adam::Bs2PhiPhi_Adam(const Bs2PhiPhi_Adam& copy) :
...
/*****************************************************************************/
// Destructor
Bs2PhiPhi_Adam::~Bs2PhiPhi_Adam()
{
}
/*****************************************************************************/
// Code common to the constructors
void Bs2PhiPhi_Adam::Initialise()
{
...
void Bs2PhiPhi_Adam::MakePrototypes()
{
...
bool Bs2PhiPhi_Adam::SetPhysicsParameters(ParameterSet* NewParameterSet)
{
...
/*****************************************************************************/
// List of components
vector<string> Bs2PhiPhi_Adam::PDFComponents()
{
  return componentlist;
}
/*****************************************************************************/
// Evaluate a single component
double Bs2PhiPhi_Adam::EvaluateComponent(DataPoint* measurement, ComponentRef* component)
{
...
double Bs2PhiPhi_Adam::Evaluate(DataPoint* measurement)
{
...
/*****************************************************************************/
double Bs2PhiPhi_Adam::Normalisation(PhaseSpaceBoundary* boundary)
{
  (void)boundary;
  return 1;
}
